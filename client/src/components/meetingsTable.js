    ...
    return (
        <div className="mt-12">
            ...
            <div className="w-full divide-y mt-4 border rounded-xl">
                {m.meetings.map(meet=>{
                    return <div key={meet.meetingId} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 w-full p-4">
                        ...
                        <div className={`${colClass} justify-end md:justify-start`}>{meet.client.firstName} {meet.client.lastName}</div>
                        ...
                        <div className="text-right hidden lg:block">
                            ...
                            <span className="py-1 px-4 rounded-full bg-red-100 text-red-500 cursor-pointer">Cancelled</span>}
                        </div>
